---
name: realt-flow
description: Ведёт флоу REALT-фичи под ключ: ссылка на сторю YouTrack → фича-ветка от stage + draft-MR → таск-ветки → MR тасков → итоговое сообщение. Триггеры: «новая сторя», «создай флоу по REALT-…», «оформи MR». Также баги и мелкие таски без фичи.
---
